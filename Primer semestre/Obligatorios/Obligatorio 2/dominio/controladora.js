...
function ListarMasVendidas() {
    ...
    for(const objetoPelicula of peliculas) { 
        let elemento = new Option(`${objetoPelicula.nombre} (alquilada ${objetoPelicula.ventas} ${objetoP-ulicula.ventas == 1 ? 'vez' : 'veces'})`, objetoPelicula.id);
